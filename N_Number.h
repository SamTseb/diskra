...
public:
    ...
    N_Number SUB_NN_N(N_Number number_2)
    {
        ...
        return number_2; //¬озвращает -1, если первое число меньше второго.
    }
    ...
    N_Number DIV_NN_Dk(N_Number number_2)
    {
        ...
        return answer; //¬озвращает -2, если пытаемс€ делить на 0.
    }
    ...
    N_Number LCM_NN_N(N_Number number_2)
    {
        ...
        {
            number_2.number[0]=-3;
            return number_2; //¬озвращает -3, если оба числа равны 0.
        }
